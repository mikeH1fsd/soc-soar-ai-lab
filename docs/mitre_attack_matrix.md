...
| **Execution** | User Execution: Malicious File | `T1204.002` | Wazuh FIM Realtime (`Downloads\` folder) | Rule 100055 (Level 12) | Truy vấn VirusTotal SHA256 + Bộ lọc Gatekeeper + 1-Click File Quarantine | File `lesson29.exe` biến mất khỏi Windows Explorer | Mã độc chưa có chữ ký trên VirusTotal (Zero-day payload) lọt qua bộ lọc CTI. |
